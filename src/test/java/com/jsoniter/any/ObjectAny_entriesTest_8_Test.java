...
public class ObjectAny_entriesTest_8_Test {
//failed_run   @Test
...
//
//    // Act
//    Any.EntryIterator actual = objectAny.entries();
//
//    // Assert
//    Assert.assertTrue(actual instanceof ObjectAny.IteratorAdapter);
//    Assert.assertNotNull(((ObjectAny.IteratorAdapter) actual).toString());
