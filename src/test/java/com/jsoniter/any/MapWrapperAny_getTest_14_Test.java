...
public class MapWrapperAny_getTest_14_Test {
//failed_pass   @Test
...
//    Object[] objectArray = new Object[]{string, string1, "akaaa"};
//    int idx = 1;
//
//    // Act
//    Any actual = mapWrapperAny.get(objectArray, idx);
//
//    // Assert
...
//    Assert.assertEquals("akaaa", object2);
