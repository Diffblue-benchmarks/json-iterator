...
public class CodegenImplObjectHash_genNewInstCodeTest_4_Test {
  @Test
  public void genNewInstCodeTest() throws Exception {
    // Arrange
    ...
    CodegenImplObjectHash.genNewInstCode(resultClass, constructorDescriptor);
